...
const [btmtext, setMybtmtext] = useState("Enable dark mode")
...
const changeMode =()=>{
    if(mystyle.color ==='white'){
       ...
       setMyStyle ({
             ...
             setMybtmtext("Enable Light Mode")
    }
}
  ...
  return (
    <div className='container my-3' style={mystyle}>
        ...
        <div className='container my-3'>
            <button onClick={changeMode} type="button" className="btn btn-primary">{btmtext}</button>
        </div>
    </div>
  )
}
